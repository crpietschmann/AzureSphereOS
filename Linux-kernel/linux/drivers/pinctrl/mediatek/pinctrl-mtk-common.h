 ...
 *
 * @offset_bits: The number of bits in a pin number that are used as an offset 
 *  when indexing into a register. 
 * @port_shf: The shift between two registers.
 * @mux_port_shf: The shift between two mux control registers. In some chips 
 *  the shift between mux registers is different than for other control regs.
...
struct mtk_pinctrl_devdata {
	...
	unsigned int (*spec_get_regmap)(unsigned int *pin);
	unsigned int (*spec_din_offset)(unsigned int pin);
	unsigned int dir_offset;
	unsigned int ies_offset;
	unsigned int smt_offset;
	unsigned int pullen_offset;
	unsigned int pullsel_offset;
	unsigned int pulldn_offset;
	...
	unsigned char  modes_per_reg;
	unsigned char  offset_bits;
	unsigned char  port_shf;
	unsigned char  mux_port_shf;
	unsigned char  get_port_shf;
